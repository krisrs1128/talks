...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[options]{figure/pca_scores_total_lm}
...
\begin{frame}
  \frametitle{CCA}
\begin{itemize}
\item We subset to 54 species passing a $k$-over-$0$ filter, since otherwise
  covariance estimation is poorly defined. We use $\texttt{rlog}$-transformed
  species abundances.
\end{itemize}
\end{frame}
