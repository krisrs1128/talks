...
.pull-right[
  <div class="caption">
  <img src="figures/fnucleatum_matched_pairs.png" width=575/>
  <br/>
  The original data presented in `r Citep(bib, "Castellarin2011")`. Each bar is
  a patient, and the y-value is the estimated relative change in abundance
  between disease vs. matched healthy tissue.
  </div>
]
