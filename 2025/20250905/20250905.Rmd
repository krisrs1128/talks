...
In `r Citep(bib, "Sankaran2025")`, we used the focus-plus-context principle to
interactively explore how dimensionality reduction methods like UMAP distort the
intrinsic geometry of the data.

.center[
  <img src="figures/pbmc_isometry.gif" width=800/>
]
...
.center[
  <img src="figures/pbmc_boxplot.gif" width=800/>
]
...
<img src="figures/simulation_summary.png"/>
...
* You can learn more at [https://go.wisc.edu/pgb8nl](https://go.wisc.edu/pgb8nl).
    ...
    - Visualization: `r Citep(bib, c("Sankaran2025", "Fukuyama2022", "Sankaran2018", "Sankaran2019"))`
