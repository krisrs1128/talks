---
title: "Applying Machine Learning to Support Diabetic Retinopathy Screening"
...
Slides: <a href="https://go.wisc.edu/">go.wisc.edu/596alz</a><br/>
...
### Introductions: Darren

- Expertise: Statistics and machine learning for microbiome analysis.
- Path to this project:

- Co-mentored by Prof. Ogunyemi (UCLA Preventive and Social Medicine) and me.
...
- Path to project: Met Darren at CGSI and shared resources to help with MS
...
- Darren has focused on two papers `r Citep(bib, c("Ogunyemi2021", "Ding2023"))`:
...
performance in settings most relevant to Prof. Ogunyemi's lab
...
- Darren is coordinating data and code access to ensure we can replicate these results.
