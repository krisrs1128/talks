...
For example, in mediation analysis, expect the treatment to affect an omic dataset indirectly through an intermediary `r Citep(bib, c("clark2023methods", "vanderweele2016mediation"))`.
