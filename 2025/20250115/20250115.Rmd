...
the basis for techniques like small multiples `r Citep(bib, "tufte1983visual")`
and piling `r Citep(bib, "lekschas2020generic")`.
...
Here are the ECDF plots for taxa that are differentially abundant across BMI
groups in the Atlas study of healthy European adults `r Citep(bib, "Lahti2014")`.  Curves further to the right have systematically larger
abundances.
...
approximation of a high-dimensional data cloud `r Citep(bib, "Nguyen2019")`.
...
another as possible `r Citep(bib, "sankaran2019multitable")`.
...
shared and distinct components, there are closely-related alternatives, like `r Citep(bib, c("lin2023quantifying", "Palzer2022"))`.
