...
versions, like the sparse PCA we used here `r Citep(bib, "spca")`, can be more stable `r Citep(bib, c("zou2006sparse", "mackey2008deflation"))`.
...
1. Other helpful visualization in microbiome research are residual plots `r Citep(bib, "faraway2002practical")`, partial dependence `r Citep(bib, c("sankaran2024mbtransfer", "friedman2001greedy"))`, phylogenetic `r Citep(bib, "mcmurdie2013phyloseq")`,
