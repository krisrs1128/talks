...
ggsave("../reveal.js/figures/ecdf_testing.png", width = 11, height = 3.5, bg = "transparent")
```
...
ggsave("../reveal.js/figures/ecdf_overall.png", width = 11, height = 3.5, bg = "transparent")
...
ggsave("../reveal.js/figures/histogram_narrow.png", width = 11, height = 3.5, bg = "transparent")
...
ggsave("../reveal.js/figures/histogram_wide.png", width = 11, height = 3.5, bg = "transparent")
```
...
assay_df |>
  filter(taxon %in% taxon[1:12]) |>
  ggplot() +
    stat_ecdf(aes(log(1 + value, 10)), linewidth = 1) +
    scale_y_continuous(expand = c(0, 0, 0.1, 0)) +
    scale_x_continuous(expand = c(0, 0)) +
    facet_wrap(~ reorder(taxon, -value), ncol = 6, scales = "free") +
    labs(x = "Taxon Count (log scale)", y = "Empirical CDF") +
    theme(
      strip.text = element_text(size = 10), 
      panel.background = element_rect(fill = "transparent"), 
      plot.background = element_rect(fill = "transparent", color = NA),
...
ggsave("../reveal.js/figures/ecdf_log.png", width = 11, height = 3.5, bg = "transparent")
```