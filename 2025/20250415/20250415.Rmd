...
underlying data. When the data are normalized (like here), it is enough to use a
multivariate Gaussian model. More generally, we have found copula models useful
`r Citep(bib, c("Joe2023-xb", "Deek2023-dc", "Sun2021-lg"))`. In both cases,
it's important to apply a high-dimensional covariance estimator.
