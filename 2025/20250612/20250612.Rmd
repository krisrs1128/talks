...
Some neighborhoods are "broken" in the sense that all neighbors of a point have
poorly preserved distances. One approach is:
...
We can summarize this approach graphically:
