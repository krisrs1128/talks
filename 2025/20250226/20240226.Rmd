...
<span style="font-size: 18px;">
The same person can jump between clusters in longitudinal sampling `r Citep(bib, "Knights2014-jv")`, which
...
The final simulation mimics the strain switching problem `r Citep(bib, c("Jeganathan2021", "Reiter2022"))`.
...
.center[
<img src="figure/strain_switching.png" width=850/>
]
...
.pull-left[
Reference `r Citep(bib, "Ravel2010")` used clustering to identify 5 Community State Types (CSTs) in
...
```{r, results='asis', echo = FALSE}
PrintBibliography(bib, start = 27, end = 34)
```
