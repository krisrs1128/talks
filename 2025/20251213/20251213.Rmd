...
Preprint: <a href="https://go.wisc.edu/oe3g62">go.wisc.edu/oe3g62</a><br/>
...
Consider the KNN graph of a dataset. Two points are considered close if a random
walk started at one point has a high probability of reaching the other within
$t$ time steps.

.center[
<img src="figures/laplacian_metric-0.png" width=800/>
]
...
.center[
<img src="figures/laplacian_metric.png" width=800/>
]
...
.center[
<img src="figures/distortion_example_1.png" width=1000/>
]
...
.center[
<img src="figures/distortion_example_1-2.png" width=750/>
]
...
.center[
<img src="figures/rmetric_explanation-v2.png" width=800/>
]
...
.center[
<img src="figures/distortion_example_2.png" width=800/>
]
...
.center[
<img src="figures/distortion_example_2-2.png" width=400/>
]
...
.pull-left[
In this case, we look directly for outliers in the scatterplot of true vs.
...
**Preprint**: https://go.wisc.edu/oe3g62<br/>
