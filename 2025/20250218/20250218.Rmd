...
* **Step 1 (Estimate)**: Train a simulator on the original data.

* **Step 2 (Alter)**: Define negative control taxa with no association with T1D.

* **Step 3 (Compare)**: Evaluate prediction performance of SPLS-DA applied to semisynthetic data with varying sample sizes and fractions of negative control taxa.
...
.center[
<img src="figures/crossroads.png" width=670/>
]
...
.center[
<img src="figures/mindfulness-altered.png" width=800/>
]
