...
- AlphaGenome
    - Could predict polyadenalation QTLs despite not including polyadenalation signals as a response track during training.
- TraitGym
    - Defined zero-shot scores for causal variant prediction across mendelian and complex traits.
