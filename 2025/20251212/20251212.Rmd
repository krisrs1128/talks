...
**MRPA assays**: Several papers also tested whether their models could predict
...
\begin{align*}
z\left(\text{alt}\right) \text{vs.} z\left(\text{alt}\right).
\end{align*}
...
.pull-left[
Note that there is a follow-up `r Citep(bib, "Tu2025")`.
]
