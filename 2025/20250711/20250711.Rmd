...
simChef `r Citep(bib, "")` makes it easier to specify and execute simulators by
creating a tidy interface for specification and drawing from parallelization
routines for computation.  Our study focuses on how to create DGP modules for
high-dimensional omics applications.
