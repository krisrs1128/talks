...
#  Causal Mediation Analysis in Microbiome Studies
...
1. For identification of direct and indirect effects, it's necessary to make
untestable assumptions (listed in the appendix). Nonetheless, the consequences
of their violation can be explored using sensitivity analysis.
...
potential for inflammatory bowel disease (Ulcerative Colitis and Crohn's
Disease).
...
This direction could be debated, but follows the discussion in `r Citep(bib, "Franzosa2018")`. 
