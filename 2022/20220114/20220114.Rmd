...
Need ways for,
- Interactively examining relationships between hypothetical designs
...
* Dirichlet prior on differential subset of ASVs for last $K_2$ columns of $B$
]
