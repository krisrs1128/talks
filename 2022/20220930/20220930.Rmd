...
1. Molecular interaction networks are useful for both interpretation and integration
...
Correlation vs. partial correlation, from Hawe et al. 2021.
...
Azadkia and Chatterjee seek to develop a conditional dependence estimator that is provably consistent without assuming any model structure.
...
* How much does knowing $\*Z$ help predict $Y_{t}$, even after we
already know $\*X$?

.pull-left[
<img src="figures/conditional_independent.svg" width=440/>
]

.pull-right[
<img src="figures/conditional_dependent.svg" width=430/>
]
...
1. Recently, Azadkia and Buhlmann used this conditional dependence measure as the basis for a causal discovery algorithm.
2. How does this approach compare to the graphical lasso and random forest methods for multi-omics network construction described at the start?
3. With many zeros, we will have many ties in the ranks $R_i$. In what ways should we modify the measure? If we truncate the ranks, is there any theoretical justification?