...
info %>%
  ...
  ggplot() +
  geom_tile(aes(timepoint, reorder(subject, total), fill = as.factor(trt))) +
  scale_x_continuous(expand = c(0, 0), breaks = 1:3) +
  scale_fill_manual(values = c( "#F2C572", "#BF4B75")) +  facet_grid(group ~ ., scale = "free_y", space = "free_y") +
labs(x = "Timepoint", y = "Subject", fill = "Intervention?") +
theme(
