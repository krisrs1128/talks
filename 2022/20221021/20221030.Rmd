...
.pull-left[
1. In `r Citep(bib, "sankaran2019latent")`, we reanalyzed data from `r
Citep(bib, "dethlefsen2011incomplete")`, which took species counts from 3
...
* Meditation may influence the Gut-Brain Axis `r Citep(bib, c("foster2013gut", "carabotti2015gut", "mayer2015gut"))`
]

.pull-right[
<img src="figures/microbe-mind.svg"/>
]
...
$\beta_{T}$.
* A more general approach considers the counterfactual difference in potential outcomes `r Citep(bib, c("imai2010general"))`,
\begin{align}
...
\end{align*}
where $\varphi^{-1}\left(z\right) \propto\left(\exp{z_{1}}, \dots, \exp{z_{K-1}}, 1\right)$. I've included details in supplementary slides.
]
...
* Consider the problem of evaluating an LNM model. We will estimation quality
when we simulate from,
 - The LNM itself
