...
* It is the statistical analog of the Focus-plus-Context data visualization principle `r Citep(bib, c("hauser2004interactive", "2004-doitrees-revisited"))`
]
...
Latent Dirichlet Allocation `r Citep(bib, "blei_lda")` supposes that samples $x_i \in \mathbb{R}^{D}$
...
These are the results presented in `r Citep(bib, "Symul2023")`.
