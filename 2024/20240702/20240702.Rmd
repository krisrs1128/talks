...
1. Multiple high-dimensional sources can be integrated to identify key immune
cell types and interactions.
]

.pull-right[
<img src="figures/long-covid.jpg" width=450/>
<span style="font-size: 22px;">
Summary of research from `r Citep(bib, c("stanfordStanfordMedicine", "Martinez-Colon2022-zw"))`.
</span>
]
...
.pull-right[
  ...
  <span style="font-size: 18px;">
  Scan statisitcs offer a useful lens for analyzing copy number variation `r Citep(bib, "Zhang2007-gi")`.
  </span>
]
