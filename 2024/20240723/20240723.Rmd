...
In biological problems, samples are often not cleanly separated into clusters.
For more informative exploration of these data, it helps to consider,
...
1. Multiple Scales: Study both coarse and fine-level variation simultaneously.
...
The study `r Citep(bib, "Arumugam2011")` claimed to detect "enterotypes" in the
human gut microbiome. They thought of these like blood type.

.pull-left[
> ... We identified three robust clusters (enterotypes hereafter) that are not
nation or continent-specific.

-- From the abstract in `r Citep(bib, "Arumugam2011")`
]

.pull-right[
<img src="figure/enterotypes.png" width=300/><br/>
<span style="font-size: 18px;">
The visualization that motivated the original enterotype definition.
</span>
]
...
More detailed analysis revealed that these boundaries are not so clear cut after
all `r Citep(bib, c("Yong2012-ri", "Koren2013-tb", "Bulygin2023-up", "Knights2014-jv"))`.
...
1. Topic models were independently developed for analyzing population genetics
and text data `r Citep(bib, c("Pritchard2000", "blei_lda"))`. Since then, they
have been applied widely across computational genomics 
...
mixtures between these extremes.
...
Consortium data to understand variation within and between tissues.
...
`r Citep(bib, "Dethlefsen2010")` looked at how microbiome communities changed in
response to antibiotics. Some sort of summarization is needed, there are too
many taxa to make sense of directly.

.center[
<iframe src="https://krisrs1128.github.io/treelapse/pages/antibiotic.html#htmlwidget-f49f5eec4ced01f92314" width=800 height=500/>
]
...
.center[
<img src="figure/antibiotic_prototypes.png" width=800/>
]
...
.pull-right[
<img src="figure/pregnancy_topics_heatmap.jpg" width=700/>
]
...
For each subject, we can visualize change in topics over time. This highlights
smooth transitions between community states.

.center[
<img src="figure/topic_trajectories_pregnancy.jpeg" width=550/>
]
