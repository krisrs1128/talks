...
1. Think in Mixtures: Instead of matching a sample to a single cluster centroid,
view them as intermediates between multiple representatives.

1. Think across Scales: Study both coarse and fine-level variation
simultaneously.
]
...
.pull-three-quarters-left[
1. Think in Mixtures $\to$ Topic Models

1. Think across Scales $\to$ Topic Alignment
]
...
Topic models `r Citep(bib, c("Pritchard2000", "blei_lda"))` have been widely
used for dimensionality reduction of count data 
...
.pull-left[
<img src="figure/GTex-topics.png" width=270/>
]

.pull-right[
<img src="figure/GTex-memberships.png" width=325/>
]
...
-- From the original STRUCTURE paper `r Citep(bib, "Pritchard2000")`
