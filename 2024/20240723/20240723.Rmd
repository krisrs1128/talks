...
In biological problems, samples are often not cleanly separated into clusters.
For more informative exploration of these data, it helps to
...
.pull-three-quarters-left[
1. Mixtures $\to$ Topic Models

1. Multiple Scales $\to$ Topic Alignment
]
...
1. Topic models `r Citep(bib, c("Pritchard2000", "blei_lda"))` are useful for
dimensionality reduction of count data 
...
<img src="figure/cluster-vs-topic.png" width=800/>
...
.pull-right[
<img src="figure/GTex-memberships.png" width=800/>
]
...
<img src="figure/GTex-topics.png" width=800/>
...
.center[
<img src="figure/antibiotic_topics.png" width=800/>
]
