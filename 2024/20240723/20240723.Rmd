...
and text data `r Citep(bib, c("Pritchard2000", "blei_lda"))` and are now widely
used in computational genomics 
...
```{r, results='asis', echo = FALSE}
PrintBibliography(bib, start = 14, end = 31)
```
