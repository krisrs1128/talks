...
Let's review a few practical techniques for model interpretation and explanation.

1. Directly interpretable model [Sparse Linear Regression]
1. Latent representation analysis [Visualizing Embeddings]
1. Local explainability method [Integrated Gradients]
1. Shared representation method [Concept Bottleneck]
...
.center[
<img src="figures/transformers_analogy.png"/>
]
...
Another common technique is to analyze linear interpolations in this space `r Citep(bib, "Liu2019LatentSC")`.  Here, I have traced out the microbiome profiles
...
### Perturbation [Local Explanations]
