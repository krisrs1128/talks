...
Statistical Power: With a given sample size and experimental design, what types of signals will be recoverable?

  * This step is required by every NIH grant.
  * In practice, 
...
`r Citep(bib, "scott1954")` is the earliest example I know of using computer
simulated data to guide scientific data analysis.

.pull-left[
  <img src="figures/galaxies-real.png"/>
]

.pull-right[
  <img src="figures/galaxies-synthetic.png"/>
]
