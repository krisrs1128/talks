...
We can use sPLS-DA for prediction when,
...
Formally, maximize the correlation between $\mathbf{X} \mathbf{a}$ and
$\mathbf{Y} \mathbf{b}$.
...
We can repeat this after removing any correlation with the previous pattern.
...
1. The blending coefficients tell you how to interpret axes in this space.
  - E.g., $a_{d} = 0$ means feature $d$ wasn't used at all.
