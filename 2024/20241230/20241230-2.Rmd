...
We can then average this over all the $x_{d}$ seen in the data, yielding a
Partial Dependence curve `r Citep(bib, "Friedman2001-xk,")`.
...
The main idea of `r Citep(bib, "Apley2020-nd")` is to resolve these issues using
the derivatives:
