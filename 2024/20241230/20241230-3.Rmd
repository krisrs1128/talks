...
`r Citep(bib, "tcav")` tried to formally test whether a concept is being used to
predict a particular class.

**Step 1**. Define a collection of images $\*x_{i}$ that represents the concept. Also consruct a control pool of random images $\*x_{i}^'$.
