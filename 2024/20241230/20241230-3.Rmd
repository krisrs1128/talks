...
`r Citep(bib, "50351")`. This is part of a literature that tries to find
representations for interacting with models `r Citep(bib, c("yuksekgonul2023posthoc", "medium_beyond_nodate", "overlooked_factors"))`.
...
.center[
<span style="font-size: 18px;">
<img src="figures/concepts_step3.png" width=520/><br/>
...
.center[
<span style="font-size: 18px;">
<img src="figures/concepts_step4.png" width=460/><br/>
