...
These annotations were generated automatically, which could make this analysis
much more automatic.
...
(example with the golden gate bridge)
...
Simple editing isn't a panacea. `r Citep(bib, "")` tried to fine-tune the
model's weights so that memorized paragraphs had lower likelihood. However,
