---
title: "Interpretability Short Course: Local Measures"
...
<img src="figures/sal_example.png"/> 
...
.center[
<span style="font-size: 18px;">
<img src="figures/lime_wax_example.png"/> 
...
.center[
<span style="font-size: 18px;">
<img src="figures/fig3_ribiero.png"/>
...
.center[
<span style="font-size: 18px;">
<img src="figures/LIME-summary1.png"/>
</span>
]
...
.center[
<span style="font-size: 18px;">
<img src="figures/LIME-summary2.png"/>
</span>
]
...
.center[
<span style="font-size: 18px;">
<img src="figures/shapley_team_1.png"/> 
...
.center[
<span style="font-size: 18px;">
<img src="figures/shapley_team_2.png"/> 
</span>
]
...
.center[
<span style="font-size: 18px;">
<img src="figures/shapley_sample_level.png"/> 
</span>
]
...
.center[
<img src="figures/shapley_v2.png"/>
]
...
.center[
<span style="font-size: 18px;">
<img src="figures/shapley_dataset_level.png"/> 
</span>
]
...
.center[
<span style="font-size: 18px;">
<img src="figures/shapley_kernel_regression.png"/> 
$\indic{d \in S}$ is known, so this is a linear regression with unknown
coefficients $\varphi_{\*x}\left(f, d\right)$
</span>
]
...
<span style="font-size: 18px;">
<img src="figures/shapley_kernel_regression.png"/> 
We can compute $v_{\*x}\left(S\right)$ on a subset of sets.
</span>
]
...
.center[
<img src="figures/l-c-shapley.png"/> 
]
