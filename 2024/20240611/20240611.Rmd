...
Instead, we consider simulation. We will simulate experiments and see what our
power and false discovery rate (FDR) look like in those hypothetical datasets.
...
* The challenge, of course, is simulating data that look realistic.

* Instead of doing this from scratch, we can train a generative
...
observed ones `r Citep(bib, "Sankaran 2020")`.
