...
1. The Poisson, Negative Binomial, and Zero-Inflated Poisson/Negative Binomial
can be used to generate count data.
1. The `SummarizedExperiment` class streamlines interaction with biological experiemnts.
1. To define a simulator in `scDesigner`, use `setup_simulator()` with R's formula syntax.
