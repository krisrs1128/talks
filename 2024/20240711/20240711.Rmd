...
How can we try to understand the transformer embeddings $z_{i}$?
...
This figure traces out the microbiome profiles between two samples.
...
1. In an interactive setting, AI can make suggestions that we then reject,
revise, or accept `r Citep(bib, c("predictive-interaction", "Heer2019-ie"))`.
