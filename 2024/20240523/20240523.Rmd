...
* To move beyond descriptive analysis and towards potential interventions, we need to understand mechanisms that underlie this relationship.
]
...
We will normalize the data to enhance power:
  ...
  * Imputation procedures make linear model assumptions viable `r Citep(bib,"Jiang2022-jt")`.
...
1. Following `r Citep(bib, c("Zhang2023-rr"))`, we will use linear models
...
across the data sources `r Citep(bib, "Sankaran2019-bf")`.
