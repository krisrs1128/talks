...
There are many points at which technical variation arise. For example, for singel-cell sequencing `r Citep(bib, "jiang2022statistics")`:
...
> If all goes well, then the article... has shown mammal kidney structure; if all goes badley, it shrinks to three hamsters in one laboratory in 1984.
>
