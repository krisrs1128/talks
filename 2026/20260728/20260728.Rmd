---
title: Towards Veridical Microbiome Analysis with Semisynthetic Data
output:
...
# Towards Veridical Microbiome Analysis with Semisynthetic Data
...
Slides: <a href="https://go.wisc.edu/1o429x">go.wisc.edu/1o429x</a><br/>
...
1. Veridical data science is a formalization of the checks that can be used to
ensure a study's findings are robust to the analysis judgment calls.

1. Simulation plays a key role in this type of analysis. Quoting from `r Citep(bib, "Yu2020")`,

> [S]imulation experiments inspired by observed data and domain knowledge are powerful tools to understand how results may behave in real-world settings....  Pairing such simulation studies with empirical evidence makes the [Data Science Life Cycle] more transparent for peers and users to review, aiding in the objectivity of science.
...
```{r illustrate_joins, echo = TRUE, eval = FALSE}
...
```{r, join_simulators_glasso, echo = TRUE, eval = FALSE}
...
.center[
<img src="figures/copula_join.png" width = 700/>
]
...
```{r join_simulators, echo = TRUE, eval = FALSE}
sim_joined <- join_pamona(sims)
```

.center[
<img src="figures/simulator_join.png" width = 1200/>
]
...
* `scDesigner` - [Under-development](github.com/krisrs1128/scDesigner) version used in the first tutorial.
