...
They are also used to identify clinical relevant spatial patterns in the brain [@Schell2026].
...
[@pmlr-v149-saeedi21a] use a version of topic models adapted to CT data.  Each
patient's lung is a Dirichlet mixture of latent tissue patterns, but the final
step is a Gaussian over image features rather than multinomial.
