...
They are also used to identify brain regions with similar voxel patterns.
...
* Topics: $\beta_{k}$ describes $K$ underlying tissue subtypes.
* Memberships: $\gamma_{i}$ describes supervoxel $x_i$ as a mixture of subtypes.
...
imaging data. Each patient's lung is a Dirichlet mixture of underlying tissue
patterns, but the final step is a Gaussian rather than multinomial likelihood.

Subtypes 1 and 2 in their analysis are associated with greater COPD severity.
