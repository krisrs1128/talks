...
embedding neighbor distances, flag outliers above $\sigma \times \text{IQR}$,
and mark points with many outlier links as "fragmented."
...
- The thread in both these projects is the _focus-plus-context principle_ from data visualization [@heer2004].
