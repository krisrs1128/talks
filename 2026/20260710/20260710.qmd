...
I'll go over two recent proejcts that apply the _focus-plus-context principle_
to support high-dimensional data visualization.

> Allow readers to look up details by interacting with parts of the visualization without losing context.

This form of interactivity can help visualization withstand scientific scrutiny.
...
We can press the Cntl or number keys to cycle across a color palette.

{{<video figures/screen-across-trim.mp4>}}

Hovering over a tree nodes highlights the associated composition bar.
...
This idea works whenever you cared about hierarchically organized compositions. Our paper gives an example applied to immune cell populations.
