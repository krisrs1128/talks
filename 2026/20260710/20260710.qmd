...
filters:
  - /Users/krissankaran/Desktop/laboratory/talks/2026/20260710/split-refs.lua
format:
  revealjs:
    width: 1200
    margin: 0.04
...
Many datasets with the same summary statistics @matejka2017same.
...
like this COVID-19 immunology data from @Su2020.
...
DensMAP is designed to address density distortion [@narayan2021assessing].
...
impact scientific interpretation [@Liu2025; @Kobak2021;
@simplystatisticsSimplyStatistics]. For example, they create misleading
differences between cell types that are actually similar.

![](figures/scdeed-example.png){width=700}
scDEED tunes hyperparameters to improve embedding reliability [@xia2024statistical].
...
Our approach is similar to Tissot's indicatrix [@laskowski1989traditional]
except the embedding map doesn't have an analytical formula.
...
For a $K$-dimensional embedding map, it returns a collection of matrices
$H_{n} \in \mathbb{R}^{K \times K}$ showing how each dimension is dilated or
compressed.

![](figures/manifold_overview.png)
...
![](figures/density_stretch.png)

In this neighborhood $H_{n} \approx \begin{pmatrix} 2 & 0 \\ 0 & 0.2 \end{pmatrix}$.
...
> [https://distortionwebapp.streamlit.app/](https://distortionwebapp.streamlit.app/)

![](figures/distortions-app.png)
