---
title: "A Visual Introduction to Shapley Values"
subtitle: "UCLouvain Applied Statistics Workshop"
...
marginal feature removal approach, as implemented by `KernelExplainer`.  The $N = 2000$ rows in `X` are used in estimating the
