...
Both $t$-SNE and UMAP are introduce distortions. For example, they may not
preserve density within different regions of the plot.
...
:::: {.columns}
::: {.column width="50%"}
Besides RMetric, we also visualize distortions uses the scatterplot of true vs.
