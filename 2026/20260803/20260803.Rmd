...
Slides: <a href="https://go.wisc.edu/13fpp0">go.wisc.edu/13fpp0</a><br/>
...
E.g., it's easy to use `glm` in the `mediation` package.
...
appropriate to microbiome data. For example, if the outcome is a microbiome
profile, we use a logistic-normal multinomial model
...
where $\left(\epsilon^y, \epsilon^m\right)$ are correlated. A caveat is that
this only makes sense for continuous outcomes and mediators.
...
<img src="figures/noun-data-science-7988125.png" width=40/> **Software shapes reasoning.**

Good software democratizes statistical advances and sharpens the way research communities reason about their problems.

<img src="figures/noun-education-8424965.png" width=40/> **Open source is still important.**

Software that raises intellectual agency is even more important now that LLMs can immediately generate data analysis reports.

<img src="figures/noun-microbe-8093335.png" width=40/> **Mediation and the microbiome.**

Mediation analysis gives a precise way of specifying what might otherwise be vague integration questions.
...
* Lead Authors: Hanying Jiang, Xinran Miao
* Lab Members: Yuliang Peng, Langtian Ma, Jiaxin Ye, Cameron Jones, Helena Huang, Jiaru Gong
...
data science by Satria Arnata from <a href="https://thenounproject.com/browse/icons/term/data-science/" target="_blank" title="data science Icons">Noun Project</a> (CC BY 3.0)
