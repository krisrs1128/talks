...
My lab develops data science tools to help researchers better understand
microbial ecosystems.  We make sure that our tools can be adapted to complex
experimental designs and combinations of 'omics.

Why is multi-omics helpful? Think of the cell as a symphony.
...
Beyond visualization, we also think about interactive computing to support data
preparation (e.g., from heterogeneous studies) and generative modeling (e.g.,
for synthetic null testing).
