...
fit <- lnm_mediation(model_conf(baseline = TRUE), data_list)
```
...
.center[
# The Landscape of Causal Model Evaluation
]
...
counterfactual / hypothetical reasoning), but methods for model comparison are
still lacking.
