...
* Treatment recommendations have remained essentially unchanged in 30 years, yet treatments are known to fail often/last only temporarily
* The complexity is that BV is a disease of imbalance -- it is not the result of a single pathogen, but rather the interactions between a microbial community and the host's immune system

[Figure of the pathways for BV]
...
* Microbiome
  - 16S rRNA sequence: What are the abundances of different bacterial species?
  - Metagenomic Sequencing: What functions can those bacteria potentially carry out?
  - Metatranscriptomic Sequencing: Which bacterial genes are expressed?
* Either
...
Aside: Simple concatenation usually works poorly -- some modalities drown out
others.
...
At a time when most science focused on taxonomy, the *Tableau* pointed the way
towards an approach that highlighted interdependence and unity within nature.
