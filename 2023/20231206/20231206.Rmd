...
1. Most researchers do not routinely use simulation. The issue isn't sloppiness
in sharing or documenting code, though.

1. The deeper issue is that we usually view simulators as monolithic. We can
adjust parameters but can't interchange components. This makes them less
adaptable to new technologies or application contexts.
