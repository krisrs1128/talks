...
* **Biological Mechanisms**: Generative models can suggest improved mental models of biological processes.
...
This used partial manifold alignment to learn shared latent variables across assays and works even in the diagonal integration setting.
...
2. We will work with the `curatedMetagenomicData`, which includes 12 colorectal
cancer (CRC) studies processed with the same pipeline `r Citep(bib, "Pasolli2017AccessibleCM")`.
