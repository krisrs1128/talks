...
ecological interaction. Species that often co-occur are understood to have
...
simulate data with known correlation structure and species-level marginals
...
```{r fit_spatial, fig.height = 7, fig.width = 9, echo = FALSE}
