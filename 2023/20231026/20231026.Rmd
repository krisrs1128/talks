...
* Couple the quantiles from pairs of features using a Gaussian or Vine Copula.
...
point_opts <- list(size = 0.9, alpha = 0.6)
```
...
```{r correlation_plot, out.width = 500, fig.height = 6.5, fig.width = 10}
...
.center[
<img src="figures/simulator_join_features.png" width = 650/>
]
