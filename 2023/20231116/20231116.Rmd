...
This visualization applies dynamic linking. By coordinating interaction across
panels, we can show several views of the same data.

```{r, echo = FALSE}
library(robservable)
robservable("@krisrs1128/week-3-4", include = 5, height = 410)
```
...
pretraining acts like a regularizer, causing many independent runs to converge
to relatively similar functions.
]
