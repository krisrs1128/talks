...
```{r, out.width = 300, fig.show = "hold", echo = FALSE}
...
.pull-right[
```{r, out.width = 200, echo = FALSE, fig.cap = "Perpendicular vectors have inner product equal to 0."}
...
.pull-right[
```{r, out.width = 200, echo = FALSE, fig.cap = "When the vectors are at obtuse angles, their inner product is negative."}
