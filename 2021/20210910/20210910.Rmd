...
* You can try these ideas out in the R package `alto`
* [lasy.github.io/alto](lasy.github.io/alto)

<img src="https://uwmadison.box.com/shared/static/r8g7mpfi36x3sexdhsp07wbkvxsng03g.png" width = 950/>
---


### Project 2: Metabolomics in Model Microbiomes

.pull-left[
* Biological systems are multi-faceted, and combining several data modalities
gives a richer view than studying any one in isolation
* How does the microbiome influence the surrounding chemical environment?
* This is a key step towards engineering soil microbiomes
]

.pull-right[
<img src="https://raw.githubusercontent.com/krisrs1128/talks/master/2021/20210820/figure/compound-2.png"/>
]
...
.pull-right[
<img src="https://raw.githubusercontent.com/krisrs1128/talks/master/2021/20210820/figure/compound-1051.png"/>
]
...
.pull-right[
<img src="https://raw.githubusercontent.com/krisrs1128/talks/master/2021/20210820/figure/compound-586.png"/>
]

---
### Project 2: Metabolomics in Model Microbiomes

These are some of the estimated main effects from each fo 3882 metabolite-level
ANOVAs. Which of the metabolites are worth following up? We are studying how
some ideas from selective inference can be applied.

<img src="https://github.com/krisrs1128/talks/blob/master/2021/20210820/figure/bf-scatter.png?raw=true"/>

---

### Project 3: Monitoring Glacial Lakes

* We also apply data visualization principles to monitoring ecosystem change
* We have implemented algorithms for measuring change in glaciers and glacial
lakes
* To be useful to stakeholders, we need effective ways for navigating the
results
...
* We have implemented algorithms for measuring change in glaciers and glacial
lakes
* To be useful to stakeholders, we need effective ways for navigating the results
...
I encourage you to reach out if you are interested in these topics, even if you
are still exploring.
...
.center[
<img src="https://uwmadison.box.com/shared/static/iu2ak50emn1bpwh9fytliv5ggqqq2dlz.png" width=340/>
<img src="https://uwmadison.box.com/shared/static/ebncvy25z4q6livvmzy9b10a1th5zt33.jpeg" width=250/>
]
