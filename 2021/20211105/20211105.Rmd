...
* It can give a useful overview, but it doesn't support zooming into
...
* We will fit an ensemble of LDA models of varying levels of complexity (Parsimony, Evaluation)
...
* This dysbiotic state has also been associated with increased susceptibility to
sexually transmitted disease and painful menstruation
]
...
* Of these three dysbiotic sub-topics, two seem especially coherent
...
* These two subtypes were targeted for further study
  ...
  - Hypothesize that only 3 topics are needed due to mixed-membership, rather
  than hard clustering, approach
...
.pull-right[
```{r, echo = TRUE, fig.align = "left", fig.height = 2.8}
plot(result)
```
]
...
```{r}
include_graphics("https://uwmadison.box.com/shared/static/ebncvy25z4q6livvmzy9b10a1th5zt33.jpeg")
```
